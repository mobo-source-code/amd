...
const BtnFilled = ({text}) => {
    return (
        <a href="#_" className="relative rounded px-4 py-2 md:px-10 md:py-5 overflow-hidden group bg-primary relative hover:bg-gradient-to-r hover:from-primary hover:to-green-400 text-white hover:ring-2 hover:ring-offset-2 hover:ring-green-400 transition-all ease-out duration-300">
